  ...
  const mockAgents: Agent[] = [
    {
      ...
      role: 'orchestrator',
      version: '1.0.0',
      systemPrompt: 'AI technical lead responsible for user communication and engineering orchestration.',
      tools: ['task_management', 'agent_dispatch', 'technical_decisions'],
    ...
    },
    {
      ...
      role: 'planner',
      version: '1.0.0',
      systemPrompt: 'Background planning agent for requirements, architecture and task decomposition.',
      tools: ['requirements_analysis', 'architecture', 'task_planning'],
      model: 'configured-model',
      temperature: 0.5,
      maxTokens: 3000,
      status: 'busy',
    ...
    },
    {
      ...
      role: 'developer',
      version: '1.0.0',
      systemPrompt: 'Unified frontend, backend, database and engineering implementation agent.',
      tools: ['frontend_development', 'backend_development', 'database_design', 'terminal'],
      model: 'configured-model',
      temperature: 0.3,
      maxTokens: 2500,
      status: 'idle',
    ...
    },
    {
      ...
      version: '1.0.0',
      systemPrompt:
        'Background testing agent for verification, regression and quality assessment.',
      tools: [
        'unit_testing',
        'integration_testing',
        'e2e_testing',
